...
| `recruiter-drafts` | `node` + a DeepSeek Harness checkout with the `recruiter` profile (flash v4.1, effort low, memory MCP), `notify-send` (`libnotify`); Gmail app password + IMAP enabled |
